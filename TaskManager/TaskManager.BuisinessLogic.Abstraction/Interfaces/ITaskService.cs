...
{
    public interface ITaskService : IGenericService<TaskDetailsDTO>, IGenericSearchWithIncludesService<TaskDetailsDTO>
    {
        IServiceResult<TaskDetailsDTO> Update(int id, TaskDetailsDTO taskDTO);
    }
}
